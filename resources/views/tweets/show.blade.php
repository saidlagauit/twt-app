    ...
    <div class="container">
        <div class="col-md-8 mx-auto">
            <div class="single-page bg-body-tertiary p-3 rounded">
                ...
                @auth
                    <form class="border-top border-bottom py-2 my-2" action="{{ route('comments.store', $tweet) }}" method="POST" autocomplete="off">
                        @csrf
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        @auth
                                            @if (auth()->user()->id === $comment->user_id)
                                                <form action="{{ route('comments.destroy', [$tweet, $comment]) }}"
